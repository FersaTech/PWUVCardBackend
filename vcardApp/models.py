...
class ProductModel(models.Model):
    ...
    image1 = models.FileField(upload_to='product_images/', blank=False, null=False, default=None)
    image2 = models.FileField(upload_to='product_images/', blank=True, null=True, default=None)
    image3 = models.FileField(upload_to='product_images/', blank=True, null=True, default=None)
    image4 = models.FileField(upload_to='product_images/', blank=True, null=True, default=None)
